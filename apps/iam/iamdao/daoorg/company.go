...
func (d *CompanyDao) Insert(ctx context.Context, entity *iammodel.CompanyEntity) error {
	...
	if err := db.Create(entity).Error; err != nil {
		return code.GetError(gerror.DBInsertErr).Wrapf(err, "[CompanyDao] Insert fail, entity:%s", gutils.ToJsonString(entity))
	}
	return nil
}
...
func (d *CompanyDao) BatchInsert(ctx context.Context, entityList iammodel.CompanyEntityList) error {
	...
	if err := db.Create(entityList).Error; err != nil {
		return code.GetError(gerror.DBInsertErr).Wrapf(err, "[CompanyDao] BatchInsert fail, entityList:%s", gutils.ToJsonString(entityList))
	}
	return nil
}
...
func (d *CompanyDao) UpdateByID(ctx context.Context, id uint, entity *iammodel.CompanyEntity) error {
	...
	if err := db.Where("id = ?", id).Updates(entity).Error; err != nil {
		return code.GetError(gerror.DBUpdateErr).Wrapf(err, "[CompanyDao] UpdateByID fail, id:%d entity:%s", id, gutils.ToJsonString(entity))
	}
	return nil
}
...
func (d *CompanyDao) UpdateMap(ctx context.Context, id uint, updateMap map[string]interface{}) error {
	...
	if err := db.Where("id = ?", id).Updates(updateMap).Error; err != nil {
		return code.GetError(gerror.DBUpdateErr).Wrapf(err, "[CompanyDao] UpdateMap fail, id:%d, updateMap:%s", id, gutils.ToJsonString(updateMap))
	}
	return nil
}
...
func (d *CompanyDao) GetByCond(ctx context.Context, cond *CompanyCond) (*iammodel.CompanyEntity, error) {
	...
	if err := db.Find(&entity).Error; err != nil {
		return nil, code.GetError(gerror.DBFindErr).Wrapf(err, "[CompanyDao] GetById fail, cond:%s", gutils.ToJsonString(cond))
	}
	return &entity, nil
}
...
func (d *CompanyDao) GetListByCond(ctx context.Context, cond *CompanyCond) (iammodel.CompanyEntityList, error) {
	...
	if err := db.Find(&entityList).Error; err != nil {
		return nil, code.GetError(gerror.DBFindErr).Wrapf(err, "[CompanyDao] GetListByCond fail, cond:%s", gutils.ToJsonString(cond))
	}
...
func (d *CompanyDao) GetPageListByCond(ctx context.Context, cond *CompanyCond) (iammodel.CompanyEntityList, int64, error) {
	...
	if err := db.Count(&count).Error; err != nil {
		return nil, 0, code.GetError(gerror.DBFindErr).Wrapf(err, "[CompanyDao] GetPageListByCond count fail, cond:%s", gutils.ToJsonString(cond))
	}
	...
	var entityList iammodel.CompanyEntityList
	if err := db.Find(&entityList).Error; err != nil {
		return nil, 0, code.GetError(gerror.DBFindErr).Wrapf(err, "[CompanyDao] GetPageListByCond find fail, cond:%s", gutils.ToJsonString(cond))
	}
...
func (d *CompanyDao) CountByCond(ctx context.Context, cond *CompanyCond) (int64, error) {
	...
	var count int64
	if err := db.Count(&count).Error; err != nil {
		return 0, code.GetError(gerror.DBFindErr).Wrapf(err, "[CompanyDao] CountByCond fail, cond:%s", gutils.ToJsonString(cond))
	}
	return count, nil
}
