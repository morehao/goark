...
func (d *MenuDao) Insert(ctx context.Context, entity *iammodel.MenuEntity) error {
	...
	if err := db.Create(entity).Error; err != nil {
		return code.GetError(gconstant.DBInsertErr).Wrapf(err, "[MenuDao] Insert fail, entity:%s", gutil.ToJsonString(entity))
	}
	return nil
}
...
func (d *MenuDao) BatchInsert(ctx context.Context, entityList iammodel.MenuEntityList) error {
	if len(entityList) == 0 {
		return code.GetError(gconstant.DBInsertErr).Wrapf(nil, "[MenuDao] BatchInsert fail, entityList is empty")
	}

	db := d.DB(ctx).Table(d.TableName())
	if err := db.Create(entityList).Error; err != nil {
		return code.GetError(gconstant.DBInsertErr).Wrapf(err, "[MenuDao] BatchInsert fail, entityList:%s", gutil.ToJsonString(entityList))
	}
	return nil
}

func (d *MenuDao) UpdateByID(ctx context.Context, id uint, entity *iammodel.MenuEntity) error {
	db := d.DB(ctx).Model(&iammodel.MenuEntity{}).Table(d.TableName())
	if err := db.Where("id = ?", id).Updates(entity).Error; err != nil {
		return code.GetError(gconstant.DBUpdateErr).Wrapf(err, "[MenuDao] UpdateByID fail, id:%d entity:%s", id, gutil.ToJsonString(entity))
	}
	return nil
}
...
func (d *MenuDao) UpdateMap(ctx context.Context, id uint, updateMap map[string]interface{}) error {
	...
	if err := db.Where("id = ?", id).Updates(updateMap).Error; err != nil {
		return code.GetError(gconstant.DBUpdateErr).Wrapf(err, "[MenuDao] UpdateMap fail, id:%d, updateMap:%s", id, gutil.ToJsonString(updateMap))
	}
	return nil
}
...
func (d *MenuDao) Delete(ctx context.Context, id, deletedBy uint) error {
	...
	if err := db.Where("id = ?", id).Updates(updatedField).Error; err != nil {
		return code.GetError(gconstant.DBDeleteErr).Wrapf(err, "[MenuDao] Delete fail, id:%d, deletedBy:%d", id, deletedBy)
	}
	return nil
}
...
func (d *MenuDao) GetById(ctx context.Context, id uint) (*iammodel.MenuEntity, error) {
	...
	if err := db.Where("id = ?", id).Find(&entity).Error; err != nil {
		return nil, code.GetError(gconstant.DBFindErr).Wrapf(err, "[MenuDao] GetById fail, id:%d", id)
	}
	return &entity, nil
}
...
func (d *MenuDao) GetByCond(ctx context.Context, cond *MenuCond) (*iammodel.MenuEntity, error) {
	...
	if err := db.Find(&entity).Error; err != nil {
		return nil, code.GetError(gconstant.DBFindErr).Wrapf(err, "[MenuDao] GetById fail, cond:%s", gutil.ToJsonString(cond))
	}
	return &entity, nil
}
...
func (d *MenuDao) GetListByCond(ctx context.Context, cond *MenuCond) (iammodel.MenuEntityList, error) {
	...
	if err := db.Find(&entityList).Error; err != nil {
		return nil, code.GetError(gconstant.DBFindErr).Wrapf(err, "[MenuDao] GetListByCond fail, cond:%s", gutil.ToJsonString(cond))
	}
...
func (d *MenuDao) GetPageListByCond(ctx context.Context, cond *MenuCond) (iammodel.MenuEntityList, int64, error) {
	...
	if err := db.Count(&count).Error; err != nil {
		return nil, 0, code.GetError(gconstant.DBFindErr).Wrapf(err, "[MenuDao] GetPageListByCond count fail, cond:%s", gutil.ToJsonString(cond))
	}
	...
	var entityList iammodel.MenuEntityList
	if err := db.Find(&entityList).Error; err != nil {
		return nil, 0, code.GetError(gconstant.DBFindErr).Wrapf(err, "[MenuDao] GetPageListByCond find fail, cond:%s", gutil.ToJsonString(cond))
	}
...
func (d *MenuDao) CountByCond(ctx context.Context, cond *MenuCond) (int64, error) {
	...
	var count int64
	if err := db.Count(&count).Error; err != nil {
		return 0, code.GetError(gconstant.DBFindErr).Wrapf(err, "[MenuDao] CountByCond fail, cond:%s", gutil.ToJsonString(cond))
	}
	return count, nil
}
