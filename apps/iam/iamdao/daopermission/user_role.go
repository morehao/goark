...
func (d *UserRoleDao) BatchInsert(ctx context.Context, entityList iammodel.UserRoleEntityList) error {
	if len(entityList) == 0 {
		return code.GetError(gerror.DBInsertErr).Wrapf(nil, "[UserRoleDao] BatchInsert fail, entityList is empty")
	}
...
func (d *UserRoleDao) Delete(ctx context.Context, id, deletedBy uint) error {
	...
	if err := db.Where("id = ?", id).Updates(updatedField).Error; err != nil {
		return code.GetError(gerror.DBDeleteErr).Wrapf(err, "[UserRoleDao] Delete fail, id:%d, deletedBy:%d", id, deletedBy)
	}
	return nil
}
...
func (d *UserRoleDao) GetById(ctx context.Context, id uint) (*iammodel.UserRoleEntity, error) {
	...
	if err := db.Where("id = ?", id).Find(&entity).Error; err != nil {
		return nil, code.GetError(gerror.DBFindErr).Wrapf(err, "[UserRoleDao] GetById fail, id:%d", id)
	}
	return &entity, nil
}
