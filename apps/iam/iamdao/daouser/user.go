...
func (d *UserDao) Insert(ctx *gin.Context, entity *iammodel.UserEntity) error {
...
func (d *UserDao) BatchInsert(ctx *gin.Context, entityList iammodel.UserEntityList) error {
	if len(entityList) == 0 {
...
func (d *UserDao) UpdateByID(ctx *gin.Context, id uint, entity *iammodel.UserEntity) error {
	db := d.DB(ctx).Table(d.TableName())
...
func (d *UserDao) GetById(ctx *gin.Context, id uint) (*iammodel.UserEntity, error) {
...
func (d *UserDao) GetByCond(ctx *gin.Context, cond *UserCond) (*iammodel.UserEntity, error) {
	var entity iammodel.UserEntity
	db := d.DB(ctx).Table(d.TableName())
...
func (d *UserDao) GetListByCond(ctx *gin.Context, cond *UserCond) (iammodel.UserEntityList, error) {
...
func (d *UserDao) GetPageListByCond(ctx *gin.Context, cond *UserCond) (iammodel.UserEntityList, int64, error) {
	db := d.DB(ctx).Table(d.TableName())
